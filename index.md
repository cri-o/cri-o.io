...
- Kubernetes contacts the kublet to launch a pod.
...
- CRI-O then launches an OCI Compatable Runtime using the specification to run the container proceses. The default OCI Runtime is runc.
